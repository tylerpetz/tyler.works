...
<template>
  <section class="max-w-xl rounded bg-theme-bg-d text-center mx-auto mb-16 px-6 py-10">
    <h1 class="text-theme-text-l text-lg md:text-2xl mb-6">
      <slot name="header">
        Hopefully now I have you convinced.
      </slot>
    </h1>
    <p class="text-theme-text-l md:text-lg mb-8">
      <slot name="body">
        Here are some of my links so you can check out some more of my work or hit me up about a project. See ya!
      </slot>
    </p>
