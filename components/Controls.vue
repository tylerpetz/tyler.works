...
<template>
  <aside>
    <div class="fixed bottom-0 right-0 pl-12 pt-12 pb-5 pr-4 z-20" @mouseover="hoveringControls = true" @mouseout="hoveringControls = false">
      <ul class="flex-col items-center text-right mb-8 transform transition-transform duration-200 ease-in-out" :class="controlsClasses">
